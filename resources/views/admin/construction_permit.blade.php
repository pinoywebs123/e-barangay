        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                <ul class="nav nav-tabs">
                  ...
                  <li role="presentation" class="active"><a href="{{route('admin_request_contruction_permit')}}">Construction Permit</a></li>
                  ...
                  <li role="presentation"><a href="{{route('admin_request_indingency')}}">Certificate of Indingency</a></li>
                </ul>


                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="text-center">Construction Permit</h3>
                    </div>
